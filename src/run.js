...
import {colorMethod, colorStatus, getRequestByName, indent, isInitialized, prepFetch, STATUSES} from './util.js';
...
export default function run(args) {
	...
	if (!req) {
		...
		const hl = similar.map(k => indent(fuzzysort.highlight(k, '\x1b[31m', '\x1B[0m')))
